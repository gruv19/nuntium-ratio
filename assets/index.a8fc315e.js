...
</div>`,G=e=>{const t=document.createElement("div");t.innerHTML=F(e);const n=t.firstElementChild;return n.querySelector(".error__title").append(g("\u041E\u0448\u0438\u0431\u043A\u0430")),n},w=e=>{u("nuntium. - error");const t=document.querySelector("#app");t.innerHTML="";const n=G(e);t.append(n)},E=[{path:`${i}blog/article/[a-zA-Z0-9]+`,component:Q},{path:`${i}about/?`,component:q},{path:`${i}blog/?`,component:z},{path:`${i}?`,component:Y}],J=()=>{let e=window.location.pathname;return e[e.length-1]==="/"&&(e=e.substring(0,e.length-1)),e!==`${i}index.html`?e=e.replace(/[^a-zA-Z0-9/]/g,""):(e=i,history.pushState(null,null,e)),e.length?e:i},K=e=>{const t=E.findIndex(n=>e.match(new RegExp(`^${n.path}$`,"gi")));return t>-1?E[t].component:null},V=()=>{console.log({BASE_URL:"/nuntium-ratio/",MODE:"production",DEV:!1,PROD:!0});const e=J(),t=K(e);console.log(e),console.log(t),t?t().catch(n=>w("\u0427\u0442\u043E-\u0442\u043E \u043F\u043E\u0448\u043B\u043E \u043D\u0435 \u0442\u0430\u043A...")):w("\u0422\u0430\u043A\u043E\u0439 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B \u043D\u0435 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u0435\u0442")};window.addEventListener("load",V);
