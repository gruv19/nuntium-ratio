const C=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerpolicy&&(o.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?o.credentials="include":a.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}};C();const L=()=>`<header class="header">
...
</button>`,I=()=>{const e=document.createElement("div");return e.innerHTML=y(),e.firstElementChild};const x=(e="/")=>`<nav class="nav">
  <ul class="nav__list">
...
</nav>`,H=e=>{const t=document.createElement("div");return t.innerHTML=x(e),t.firstElementChild},m=()=>{const e=document.createElement("div");e.innerHTML=L();const t=e.firstElementChild,n=$(),r=I(),a=H(window.location.pathname),o=()=>{a.parentElement.classList.contains("header__nav--active")?a.parentElement.classList.remove("header__nav--active"):a.parentElement.classList.add("header__nav--active")};return t.querySelector(".header__logo").append(n),t.querySelector(".header__burger").append(r),t.querySelector(".header__nav").append(a),r.addEventListener("click",o),t};const T=e=>`<section class="container${e!=="default"?` container--${e}`:""}"></section>`,h=e=>{const t=document.createElement("div");return t.innerHTML=T(e),t.firstElementChild};const M=e=>`<h1 class="page-name">${e}</h1>`,S=(e="Page Name")=>{const t=document.createElement("div");return t.innerHTML=M(e),t.firstElementChild};const B=e=>`<div class="about-content">${e}</div>`,N=e=>{const t=document.createElement("div");return t.innerHTML=B(e),t.firstElementChild},q=async()=>{const e=await(await fetch("https://course.7t33n.ru/rest/v1/about")).json();u(e.seo.title,e.seo.description,e.seo.keywords);const t=document.querySelector("#app");t.innerHTML="";const n=m();t.append(n);const r=h("about");t.append(r);const a=S(e.title);r.append(a);const o=N(e.content);r.append(o)};const k=e=>{const{author:t,createdAt:n,description:r,image:a,readTime:o,tag:l,title:s}=e;return`<section class="full-article">
...
</section>`};const X=e=>{const{about:t,name:n,nick:r}=e;return`<div class="author">
  ...
  </div>`},O=e=>{const t=document.createElement("div");return t.innerHTML=X(e),t.firstElementChild},j=e=>{const{author:t}=e,n=document.createElement("div");n.innerHTML=k(e);const r=n.firstElementChild,a=O(t);return r.querySelector(".full-article__author").append(a),r};const P=(e,t)=>{const{id:n=-1,title:r=""}=e,{id:a=-1,title:o=""}=t;return`<div class="pagination${n===-1?" pagination--without-prev":""}${a===-1?" pagination--without-next":""}">
  ...
  </div>`},Q=(e,t)=>{const n=document.createElement("div");return n.innerHTML=P(e,t),n.firstElementChild},R=async()=>{const e=window.location.pathname.split("/"),t=e[e.length-1],n=await(await fetch(`https://course.7t33n.ru/rest/v1/blog/article/${t}`)).json(),r=n.nextId!==null?await(await fetch(`https://course.7t33n.ru/rest/v1/blog/article/${n.nextId}`)).json():{id:-1,title:""},a=n.prevId!==null?await(await fetch(`https://course.7t33n.ru/rest/v1/blog/article/${n.prevId}`)).json():{id:-1,title:""},o=document.querySelector("#app");o.innerHTML="",u(`nuntium. - ${n.seo.title}`,n.seo.description,n.seo.keywords);const l=m();o.append(l);const s=h("article");o.append(s);const c=j(n);s.append(c),o.append(Q(a,r))};const U=(e,t)=>{const{id:n,tag:r,title:a,author:o,createdAt:l,image:s,readTime:c,description:d}=e;return`<article class="article-card ${t!="default"?`article-card--${t}`:""}">
